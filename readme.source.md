...
>
  ...
  >
    <defs>
      ...
      <mask id="leftMask">
        <rect width="280" height="520" fill="url(#leftMaskGlow)" />
      </mask>
    </defs>
    <rect width="860" height="520" fill="url(#grid)" />
    <rect width="860" height="520" fill="url(#topLeftGlow)" />
    <rect width="860" height="520" fill="url(#bottomRightGlow)" />
    <rect width="280" height="520" fill="url(#dotPattern)" mask="url(#leftMask)" />
    ...
    <path d="M 28 504 L 16 504 L 16 492" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
    <path d="M 832 504 L 844 504 L 844 492" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
  </svg>
